...
router.post('/addmovie',auth,checkRole(['user','admin']),upload.single('movie_src'), videosController.addnewmovie);
...
router.post('/watchlist', auth, checkRole(['user', 'admin']), userController.userwatchlist);
...
router.get('/profile',auth,checkRole(['user','admin']), userController.userProfile);
